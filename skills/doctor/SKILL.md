...
- `visual_surfaces` is validation-only; doctor does not deep-invoke Lavish or spend npm/network/cache by running the provider command. Invalid provider/mode/artifact_root/artifact_retention/workflow override shape is a config failure.
