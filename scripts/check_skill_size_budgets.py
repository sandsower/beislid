...
BUDGETS = {
    ...
    "skills/roundup/step-1-intake.md": 4_000,
    "skills/roundup/step-2-analyze.md": 4_000,
    "skills/roundup/step-3-sort.md": 4_000,
    "skills/roundup/step-4-handoff.md": 4_000,
...
PHASE_AUX_HEADINGS = {
    ...
    "skills/roundup/step-1-intake.md": "# roundup step 1 intake v1",
    "skills/roundup/step-2-analyze.md": "# roundup step 2 analyze v1",
    "skills/roundup/step-3-sort.md": "# roundup step 3 sort v1",
    "skills/roundup/step-4-handoff.md": "# roundup step 4 handoff v1",
