...
REQUIRED_REFERENCES = {
    ".beislid/workflow-md-format.md": [
        ...
        "approve_revise_or_choose_blueprint",
        "resolve_revise_or_choose_poke_holes",
        "selected_option",
    ],
    ".beislid/visual-surface-protocol.md": [
        "BEISLID_VISUAL_PROMPT_V1",
    ...
    "docs/configuration.md": [
        ...
        "unknown action",
        "freeform-only feedback",
        "planning workflow surfaces",
        "blueprint` approve/revise/choose",
        "poke-holes` resolved/revise/choose",
        "selected_option",
        "Show Me deck routing",
        "artifact_retention",
    ],
    ...
    "skills/blueprint/SKILL.md": [
        "beislid:visual_surfaces",
        "visual-surface-protocol.md",
        "plan`, `comparison`, `diagram`, and `input` guidance",
        "BEISLID_VISUAL_FEEDBACK_V1",
        "approve_revise_or_choose_blueprint",
        "selected_option",
        "canonical Markdown/chat design record",
        "explicit blueprint approval before `implement`",
    ],
    "skills/blueprint/visual-surface-protocol.md": [
        "BEISLID_VISUAL_PROMPT_V1",
        "BEISLID_VISUAL_FEEDBACK_V1",
        "Blueprint design surface loop",
        "Poke-holes decision-tree surface loop",
    ...
    "skills/poke-holes/SKILL.md": [
        ...
        "visual-surface-protocol.md",
        "decision tree",
        "comparison`, `diagram`, and `input` playbook guidance",
        "BEISLID_VISUAL_FEEDBACK_V1",
        "resolve_revise_or_choose_poke_holes",
        "selected_option",
        "canonical Markdown/chat stress-test record",
    ],
    "skills/poke-holes/visual-surface-protocol.md": [
        "BEISLID_VISUAL_PROMPT_V1",
        "BEISLID_VISUAL_FEEDBACK_V1",
        "Blueprint design surface loop",
        "Poke-holes decision-tree surface loop",
    ...
    "docs/skills.md": [
        ...
        "beislid:visual_surfaces",
        "blueprint` design comparisons/diagrams",
        "poke-holes` decision trees/tradeoffs",
...
def main() -> int:
    ...
    aux_copies = [
        ...
        root / "skills/blueprint/visual-surface-protocol.md",
        root / "skills/poke-holes/visual-surface-protocol.md",
    ]
    if canonical.exists():
