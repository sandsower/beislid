...
The verifier checks ticket fetch, lifecycle-action execution, temp-file ticket update posting, step 1-8 evidence, codebase exploration, blueprint/single-PR routing, and implement handoff evidence.
